...
class Api::Public::SmartLinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "show: returns name, slug, status" do
    get "/api/public/smart_links/#{@smart_link.slug}"
    assert_response :ok
  ...
  test "show: records smart_link_opened event" do
  ...
  test "show: returns 404 for unknown slug" do
    get "/api/public/smart_links/does-not-exist"
  ...
  test "validate: response includes smartLink with name and slug" do
    post_validate
  ...
  test "validate: returns 422 for missing coordinates" do
    post "/api/public/smart_links/#{@smart_link.slug}/validate",
  ...
  test "validate: returns 404 for unknown slug" do
    post "/api/public/smart_links/does-not-exist/validate",
